...
SELECT * 
    ...
    WHERE last_name 
        LIKE 'E%' 
        OR last_name LIKE '%E'; -- #Starts or Ends with 'e' = 30,723 observations

SELECT * 
    FROM employees
    WHERE last_name LIKE '%E' 
        AND last_name NOT LIKE 'E%' -- Ends with E but does not Start with E = 23393 
...
SELECT * 
    FROM employees
    WHERE last_name LIKE '%E' 
        AND last_name LIKE 'E%'; -- 899 start and end with e. 
...
SELECT *
    FROM employees 
    WHERE birth_date LIKE '%-12-25'; -- 842 employees were born on Christmas 
...
SELECT *
    ...
    WHERE hire_date LIKE '199%'
        AND birth_date LIKE '%-12-25'; --362 employees born on Christmas as nineties babies. 
