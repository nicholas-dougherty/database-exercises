...
ORDER BY hire_date
LIMIT 5; #Yinghua Dredge, Jinpo Langford, Tiina Speek, Takahira Spataro, Jaber Piveteau;
...
WHERE hire_date LIKE '199%-12-25'
ORDER BY hire_date
LIMIT 50; # Bingo was his name-o. 

-- LIMIT and OFFSET can be used to create multiple pages of data. What is the relationship between OFFSET (number of results to skip), LIMIT (number of results per page), and the page number?

# OFFSET can be seen as flipping ahead to a particular 'page,' batch or grouping, and the amount of content appearing on this 'page' is determined by the LIMIT. 